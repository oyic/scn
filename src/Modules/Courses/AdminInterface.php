...
class AdminInterface {
    ...
    public function enqueueAdminScripts($hook) {
        ...
        if ($post_type === 'course' && in_array($hook, ['post.php', 'post-new.php'])) {
            wp_enqueue_media();
    ...
    public function addImageUploaderScript() {
        ...
        jQuery(document).ready(function($) {
            ...
            $('#course_upload_image').click(function(e) {
                e.preventDefault();
                ...
                courseImageUploader.on('select', function() {
                    ...
                    $('#course_image_id').val(attachment.id);
                    $('#course_image_preview').html('<img src="' + attachment.sizes.medium.url + '" alt="' + attachment.alt + '" />');
                    $('#course_remove_image').show();
                });
                
                courseImageUploader.open();
            });
            
            $('#course_remove_image').click(function(e) {
                e.preventDefault();
                $('#course_image_id').val('');
