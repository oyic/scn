...
<div class="scn-profile-container">
    <div class="scn-profile-header">
        ...
        <div class="scn-profile-info">
            ...
            <?php if (($website && $website !== $main_url) || $linkedin || $twitter || $facebook || $instagram || $youtube): ?>
                <div class="scn-social-icons-wrapper">
                <div class="scn-social-icons">
                    <?php if ($website && $website !== $main_url): ?>
                        <a href="<?php echo esc_url($website); ?>" target="_blank" class="scn-social-icon-link" title="Website">
                    ...
                    <?php endif; ?>
                    <?php if ($linkedin): ?>
                        <a href="<?php echo esc_url($linkedin); ?>" target="_blank" class="scn-social-icon-link" title="LinkedIn">
                            <svg class="scn-social-icon" viewBox="0 0 24 24" fill="currentColor">
                    ...
                    <?php endif; ?>
                    <?php if ($twitter): ?>
                        <a href="<?php echo esc_url($twitter); ?>" target="_blank" class="scn-social-icon-link" title="Twitter">
                            <svg class="scn-social-icon" viewBox="0 0 24 24" fill="currentColor">
                    ...
                    <?php endif; ?>
                    <?php if ($facebook): ?>
                        <a href="<?php echo esc_url($facebook); ?>" target="_blank" class="scn-social-icon-link" title="Facebook">
                            <svg class="scn-social-icon" viewBox="0 0 24 24" fill="currentColor">
                    ...
                    <?php endif; ?>
                    <?php if ($instagram): ?>
                        <a href="<?php echo esc_url($instagram); ?>" target="_blank" class="scn-social-icon-link" title="Instagram">
                            <svg class="scn-social-icon" viewBox="0 0 24 24" fill="currentColor">
                    ...
                    <?php endif; ?>
                    <?php if ($youtube): ?>
                        <a href="<?php echo esc_url($youtube); ?>" target="_blank" class="scn-social-icon-link" title="YouTube">
                            <svg class="scn-social-icon" viewBox="0 0 24 24" fill="currentColor">
