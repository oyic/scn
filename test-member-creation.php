<?php
/**
 * Test script to verify member post type and user creation
 */
...
echo "<h1>SCN Membership - Member Creation Test</h1>";
...
if (post_type_exists('member')) {
    ...
    echo "<div class='info'>💡 The post type needs to be registered first</div>";
}
